              ...
              <div class="detail_list"  >
                ...
                <div class="detail_list_content">
                    ...
                    <div class="detail_list_info">
                        ...
                        <p>{{ detailMovie.src }} / {{ detailMovie.during }}分钟</p>
                        <p>{{ detailMovie.rt }}大陆上映</p>
                    </div>
                </div>
            </div>
            <div class="detail_intro">
                <p>{{ detailMovie.intro }}</p>
            </div>
...
export default {
    ...
    mounted(){
       this.pnumber = this.movieId

        console.log("movieid" + this.pnumber)
       this.axios.get('/json/detail.json').then(
            (res) => {
                this.ms = res.data
                for(let i=0;i<this.ms.length;i++){
                    if(this.ms[i].id == this.pnumber){
                        this.detailMovie = this.ms[i]
